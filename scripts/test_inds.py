...
#     [1687910400000, np.nan, np.nan, np.nan, np.nan, np.nan],
#     [1687996800000, np.nan, np.nan, np.nan, np.nan, np.nan],
#     [1688083200000, np.nan, np.nan, np.nan, np.nan, np.nan],
    ...
    #[1690848000000, np.nan, np.nan, np.nan, np.nan, np.nan],
